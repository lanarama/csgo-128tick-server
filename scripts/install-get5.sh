...
# copied from https://github.com/AgderLAN/csgo-get5-docker/blob/master/csgo/files/install-get5.sh


URL_METAMOD="https://mms.alliedmods.net/mmsdrop/1.11/mmsource-1.11.0-git1144-linux.tar.gz"
URL_SOURCEMOD="https://sm.alliedmods.net/smdrop/1.10/sourcemod-1.10.0-git6504-linux.tar.gz";
URL_GET5="https://github.com/splewis/get5/releases/download/0.7.2/get5_0.7.2.zip"
